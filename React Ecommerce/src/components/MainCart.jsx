        ...
        <div className=''>
            <div className="relative text-white h-[316px] overflow-hidden flex justify-center">
                ...
                <div className="relative z-10 flex flex-col justify-center items-center text-center">
                    <img src={Main} alt="" />
                    <h1 className="text-5xl font-medium leading-tight mb-1 text-black">Cart</h1>
            ...
            <div className='container flex justify-around pb-[85px] pt-[72px]'>
                <div >
                    <table className='w-[817px]'>
                        <thead className='bg-[#F9F1E7]'>
                            <tr >
                                <th className='py-[16px]' ></th>
                                <th className='py-[16px] text-left' >Product</th>
                                <th className='py-[16px] text-left' >Price</th>
                                <th className='py-[16px] text-left' >Quantity</th>
                                <th className='py-[16px] text-left' >Subtotal</th>
                                <th className='py-[16px]' ></th>
                            </tr>
                        </thead>
                        <tbody className='pt-[55px]' >
                            <tr>
                                <td colspan="5" className="pt-[55px]"></td>
                            </tr>
                            <tr>
                                <td>
                                    <img src={Dataimg} alt="" />
                                </td>
                                <td className='text-footer-xt'>Asgaard sofa</td>
                                <td className='text-footer-xt'>Rs. 250,000.00</td>
                                <td className=''> <span className='border py-[4px] px-[13px] rounded-[5px] border-footer-xt'>1</span></td>
                                <td >Rs. 250,000.00</td>
                                <td><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='bg-[#F9F1E7] text-center w-[393px] pt-[15px] pb-[83px]'>
                    <h2 className='text-3xl font-semibold pb-[63px]'>Cart Totals</h2>
                    <div className='flex justify-around pb-[31px]'>
                        <p className='font-bold'>Subtotal</p>
                        <p className='text-footer-xt'>Rs. 250,000.00</p>
                    </div>
                    <div className='flex justify-around items-end pb-[48px]'>
                        <p className='font-bold'>Total</p>
                        <p className='text-xl text-page-active'>Rs. 250,000.00</p>
                    </div>
                    <button className='w-[222px] py-[14px] border rounded-[15px] border-black'>
                        Check Out
                    </button>
                </div>
            </div>
