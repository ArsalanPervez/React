...
function Shop() {
    ...
    const toggleSelectBox = (value, products) => {
        setShowHideSelect(prevState => !prevState)
    }
    useEffect(() => {
        getData()
    }, [])
    ...
    return (
        <div>
            <Breadcrums title={'Shop'} navigation={navigation} />
                ...
                <div className='container flex items-center justify-between'>
                    <div className='flex items-center gap-8'>
                        ...
                        <div className='relative w-full'>
                            <div onClick={toggleSelectBox} className='bg-white rounded-lg p-2.5 cursor-pointer'>
                                Filter by Category    
                            </div>
                            {showHideSelect ? 
                                <div className='w-full bg-white absolute z-[9] shadow p-2.5 border-t rounded-md'>
                                    <span className='bg-gray-50 hover:bg-gray-200/60 cursor-pointer transition-all duration-100 p-1.5 mb-1 block'>Category</span>
                                    <span className='bg-gray-50 hover:bg-gray-200/60 cursor-pointer transition-all duration-100 p-1.5 mb-1 block'>Category1</span>
                                    <span className='bg-gray-50 hover:bg-gray-200/60 cursor-pointer transition-all duration-100 p-1.5 mb-1 block'>Category3</span>
                                </div>
                            : ''
                            }
                        </div>
            ...
            <div className='container py-14'>
                <div className='flex items-center justify-center text-start flex-wrap gap-5'>
                    {loading ? <p>Loading...</p>  : products && products.map((product, index) => (
            ...
            {/* <div className='container flex items-center justify-center gap-9 pb-20'>
                <div className='size-14 bg-page-active text-white flex items-center justify-center rounded-[10px]'>1</div>
                <div className='size-14 bg-white text-black flex items-center justify-center rounded-[10px]'>2</div>
                <div className='size-14 bg-white text-black flex items-center justify-center rounded-[10px]'>3</div>
                <div className='w-[98px] h-[60px] bg-white text-black flex items-center justify-center rounded-[10px]'>Next</div>
            </div> */}
