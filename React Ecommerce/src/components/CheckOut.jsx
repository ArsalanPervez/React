        ...
        <div>
            <div className="relative text-white h-[316px] overflow-hidden flex justify-center">
                ...
                <div className="relative z-10 flex flex-col justify-center items-center text-center">
                    <img src={Main} alt="" />
                    <h1 className="text-5xl font-medium leading-tight mb-1 text-black">Checkout</h1>
                    <div className='flex items-center'>
                        <a href="#" className="font-medium text-black">Home</a>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 15L11 10L6 5L7 3L14 10L7 17L6 15Z" fill="black" />
                        </svg>
                        <a href="#" className="text-black">Checkout</a>
                    </div>
            ...
            <div className='bg-white'>
                <div className='container flex pt-[98px] pb-[123px] justify-around'>
                    <div className=''>
                        <h2 className='text-4xl font-semibold mb-[36px]'>Billing details</h2>
                        <div className='flex gap-[31px]'>
                            <div>
                                <label className='block pb-[22px] font-[500]'>
                                    First Name
                                </label>
                                <input type="text" className='rounded-[10px] pl-2 h-[75px] mb-[26px] border border-footer-xt outline-none' name="" id="" />
                            </div>
                            <div>
                                <label className='block pb-[22px] font-[500]'>
                                    Last Name
                        ...
                        <input type="text" className='rounded-[10px] pl-2 h-[75px] mb-[36px] w-[453px] border border-footer-xt outline-none' name="" id="" />
                        <label className='block pb-[22px] font-[500]'>
                            Country / Region
                        </label>
                        <select name="" id="" className='rounded-[10px] pl-2 h-[75px] mb-[36px] w-[453px] border border-footer-xt outline-none'>
                            <option value=""></option>
                        ...
                        <input type="text" className='rounded-[10px] pl-2 h-[75px] mb-[36px] w-[453px] block border border-footer-xt outline-none' name="" id="" />
                        <input type="text" className='rounded-[10px] pl-4 h-[75px] w-[453px] border border-footer-xt outline-none' name="" id="" placeholder='Additional information' />
                    </div>
                    <div className='w-[608px] px-[39px]'>
                        ...
                        <div className='flex justify-between pb-[14px]'>
                            <div className='flex items-center gap-[11px]'><p className='text-footer-xt'>Asgaard sofa</p> <span className='text-[12px] font-semibold'>X</span> <span className='font-semibold text-[12px]'>1</span></div>
                            <p>Rs. 250,000.00</p>
                        </div>
                        <div className='flex justify-between pb-[14px]'>
                            <p>Subtotal</p>
                        ...
                        <div className='flex items-center justify-between pb-[33px] mb-[22px] border-b '>
                            <p>Total</p>
                            <p className='text-2xl font-[700] text-page-active'>Rs. 250,000.00</p>
                        </div>
                        <label class="flex items-center space-x-2 pb-[11px]">
                            <input type="radio" name="payment" class="peer appearance-none w-[14px] h-[14px] border-2 border-black rounded-full checked:bg-black focus:ring-0" />
                            <span class="text-black">Direct Bank Transfer</span>
                        </label>
                        <h2 className='text-footer-xt pb-[11px]'>
                        ...
                        <h2 className='pb-[11px]'>Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our privacy policy.</h2>
                        <div className='text-center pt-[39px]'>
                        <button className='mx-auto w-[318px] border border-black rounded-[15px] h-[64px] '>Place order</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className='flex justify-between items-center px-[53px] bg-features py-24'>
                <div className='flex'>
                    <div>
                    ...
                    <div>
                        ...
                        <p className='text-xl text-quality'>crafted from top materials</p>
                    </div>
                </div>
                <div className='flex'>
                    <div>
                    ...
                    <div >
                        ...
                        <p className='text-xl text-quality'>Over 2 years</p>
                    </div>
                </div>
                <div className='flex'>
                    <div>
                    ...
                    <div>
                        ...
                        <p className='text-xl text-quality'>Order over 150 $</p>
                    </div>
                </div>
                <div className='flex'>
                    <div>
                    ...
                    <div>
                        ...
                        <p className='text-xl text-quality'>Dedicated support</p>
                    </div>
                </div>
            </div>
        </div>
